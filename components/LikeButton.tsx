  ...
  return (
    <form action={handleLikeButton}>
      <button className="flex items-center space-x-1 hover:text-twitter group mx-5">
        <svg data-slot="icon" fill={state.isLiked ? "#f00" : "none"} width="25" height="25" strokeWidth="1.5" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
